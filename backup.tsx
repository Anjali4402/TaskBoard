...
export default function Home() {
  ...
  return (
    <div className=" space-y-6 sjustify-center bg-blacks flex h-100 min-h-screen flex-col items-center bg-black font-sans md:h-60 dark:bg-green-800">
      ...
      <button className="relative cursor-pointer rounded-xl border border-neutral-700 px-4 py-2 text-white group" >
